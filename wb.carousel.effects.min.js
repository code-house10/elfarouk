...
0)},10);0!=a.delay&&(d=setTimeout(function(){b.carouseleffects.frameTransition(c)},a.delay),b(c).data("timerId",d))};b.carouseleffects.killTimer=function(c){c=b(c).data("timerId");clearInterval(c)};b.carouseleffects.updateNavigation=function(c,a,d){var e=b(c).data("state");b(c).parent().find(".pagination img:eq("+a+")").attr("src",e.pagination_img_default);b(c).parent().find(".pagination img:eq("+d+")").attr("src",e.pagination_img_active)};b.carouseleffects.gotoFrame=function(c,a){b.carouseleffects.killTimer(c);
var d=b(c).data("state");0!=d.delay&&(d.current--,0>d.current&&(d.current=d.frames.length-1));a-1!=d.current&&(0==d.delay&&(d.last=d.current),d.current=Math.min(a-1,d.frames.length-1),d.delay=0,d.pagination&&b.carouseleffects.updateNavigation(c,d.last,d.current),b.carouseleffects.frameTransition(c),d.last=d.current)};b.carouseleffects.nextFrame=function(c){state=b(c).data("state");0!=state.delay&&(state.current=state.last);state.delay=0;b.carouseleffects.next(state);b.carouseleffects.frameTransition(c)};
...
"1"),b(a.frames[a.current]).css({scale:10,rotate:-180}),b(a.frames[a.current]).animate({opacity:"show",rotate:0,scale:1},{duration:a.duration,easing:a.easing,complete:function(){b(c).trigger("activate",d)}})):b(a.frames[a.current]).css("zIndex","1").show(a.mode,{},a.duration,function(){b(c).trigger("activate",d)});0!=a.delay&&(b.carouseleffects.next(a),a=setTimeout(function(){b.carouseleffects.frameTransition(c)},a.delay),b(c).data("timerId",a))};b.carouseleffects.resize=function(c){var a=0,a="undefined"!=
typeof window.innerWidth?window.innerWidth:"undefined"!=typeof document.documentElement&&"undefined"!=typeof document.documentElement.clientWidth&&0!=document.documentElement.clientWidth?document.documentElement.clientWidth:document.getElementsByTagName("body")[0].clientWidth;b(c).parent().css("width","100%");b(c).parent().css("left","0");var d=b(c).data("state");b(c).find(".frame").each(function(c){b(this).css({width:a+"px"});var f=(a-d.original_width)/2;3==d.scalemode?(d.original_width=b(this).find(".innerframe").outerWidth(),
f=(a-d.original_width)/2,b(this).find(".innerframe").css({"margin-left":f+"px"})):b(this).children().each(function(){var a;a=b(this).data("left");void 0!=a?a=parseInt(a):(a=parseInt(b(this).css("left")),b(this).data("left",a+"px"));b(this).css("left",a+f+"px")})})}})(jQuery);